...
{
  {
    ...
    boost::upgrade_lock<boost::shared_mutex> lk1(g_mutex1);
    lk1 = boost::move(lk0);
  ...
  }
  {
    ...
    lk1 = BOOST_THREAD_MAKE_RV_REF(boost::upgrade_lock<boost::shared_mutex>(g_mutex0));
    BOOST_TEST(lk1.mutex() == &g_mutex0);
    BOOST_TEST(lk1.owns_lock() == true);
  }
  {
  ...
  {
    boost::upgrade_lock<boost::shared_mutex> lk1;
    lk1 = BOOST_THREAD_MAKE_RV_REF(boost::upgrade_lock<boost::shared_mutex>(boost::unique_lock<boost::shared_mutex>(g_mutex0)));
    BOOST_TEST(lk1.mutex() == &g_mutex0);
    BOOST_TEST(lk1.owns_lock() == true);
  }
